...
def init_mission():
    ...
    mission_tasks = [
        ...
        Task(name="DEV_Task: Establish Git Push/Pull pipeline between XPS and R7910", task_type="Development", priority=1),
        Task(name="DEV_Task: Implement robust 'Architect's Sweep' for USGS API", task_type="Development", priority=2),
        Task(name="DEV_Task: Fix OperationalError by confirming R7910 SQL Services", task_type="Development", priority=1)
    ]
